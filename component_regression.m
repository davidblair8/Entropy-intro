...
% Add relevant paths
fpth{1,1} = fullfile(pth{1}, 'MATLAB','spm12');
fpth{2,1} = fullfile(pth{1}, 'MATLAB','gift','GroupICAT','icatb');
fpth{3,1} = fullfile(pth{1}, 'MATLAB','FastICA');
fpth{4,1} = fullfile(pth{1}, 'MATLAB','permutationTest');
fpth{5,1} = fullfile(pth{2}, 'Functions');
fpth{6,1} = fullfile(pth{1}, 'MATLAB','BCT');
