...
%%%% MRN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = Draw_FC_Domain_update_large(FC_input, domain, domain_ICN, Bar_range)
...
for i = 1:length(domain)
    ...
    text(-1.5, axis_domain, tx, 'Fontsize',14,'HorizontalAlignment','center', 'Rotation', 90);
    text(axis_domain, length(ICN_label) + 2.5, tx, 'Fontsize',14,'HorizontalAlignment','center');
end
