...
%%%% MRN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = Draw_FC_Domain_update_Thomas(FC_input, domain, domain_ICN, Bar_range)
...
for i = 1:length(domain)
    ...
    text(0.3, axis_domain, tx, 'Fontsize',14,'HorizontalAlignment','center', 'Rotation', 90);
    text(axis_domain, length(ICN_label) + 0.7, tx, 'Fontsize',14,'HorizontalAlignment','center');
end
